...
const footerLinks = {
  es: {
    services: [
      ...
      { name: "Mitigación de daños por agua", href: "/services/mold-mitigation", badge: "Próximamente" },
      { name: "Reparaciones handyman", href: "/services/repairs-painting", badge: "Próximamente" },
      { name: "Sellado de techos", href: "/services/roof-sealing", badge: "Próximamente" },
      { name: "Mitigación de plomo y asbesto", href: "/services/environmental", badge: "Próximamente" },
    ],
    company: [
  ...
  en: {
    services: [
      ...
      { name: "Water Damage Mitigation", href: "/services/mold-mitigation", badge: "Coming Soon" },
      { name: "Handyman Repairs", href: "/services/repairs-painting", badge: "Coming Soon" },
      { name: "Roof Sealing", href: "/services/roof-sealing", badge: "Coming Soon" },
      { name: "Lead & Asbestos Mitigation", href: "/services/environmental", badge: "Coming Soon" },
    ],
    company: [
