export const translations = {
  es: {
    ...
    home: {
      ...
      benefit4Desc: "Utilizamos productos registrados por la EPA. Aunque son seguros, proporcionamos instrucciones específicas de precaución que el cliente debe seguir para garantizar la seguridad de su familia y mascotas.",
  ...
  en: {
    ...
    home: {
      ...
      benefit4Desc: "We use EPA-registered products. Although safe, we provide specific precautionary instructions that the client must follow to ensure the safety of their family and pets.",
