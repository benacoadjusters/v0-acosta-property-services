          ...
          <div className="max-w-3xl mx-auto prose prose-neutral dark:prose-invert max-w-none">
            ...
            <div className="space-y-10">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  {es
                    ? `Este sitio web tiene fines informativos, comerciales y de generación de consultas sobre los servicios ofrecidos por ${company.name}, incluyendo control de plagas residencial y comercial, fumigación, exterminación por trampas, control biológico, control de termitas, roedores, mosquitos, chinches de cama, arañas, y plagas de césped y ornamentales. La información publicada en el sitio tiene carácter general y puede actualizarse, corregirse o modificarse sin previo aviso.`
                    : `This website is intended for informational, commercial, and lead-generation purposes regarding the services offered by ${company.name}, including residential and commercial pest control, fumigation, trap extermination, biological control, termite control, rodents, mosquitoes, bed bugs, spiders, and lawn and ornamental pest control. Information published on the site is general in nature and may be updated, corrected, or modified without prior notice.`}
                </p>
              </div>
