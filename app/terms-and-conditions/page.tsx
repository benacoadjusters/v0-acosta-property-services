          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-8 md:space-y-10">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  {es
                    ? `Este sitio web tiene fines informativos, comerciales y de generación de consultas sobre los servicios ofrecidos por ${company.name}, incluyendo control de plagas, jardinería, limpieza, window cleaning, screen cleaning, Christmas lights, pressure wash, soft wash y solar panel cleaning para propiedades residenciales y comerciales en Puerto Rico. El sitio también puede presentar servicios en desarrollo o próximamente disponibles, como plomería, electricidad, mitigación de daños por agua, reparaciones handyman, sellado de techos y mitigación de plomo y asbesto. La información publicada en el sitio tiene carácter general y puede actualizarse, corregirse o modificarse sin previo aviso.`
                    : `This website is intended for informational, commercial, and lead-generation purposes regarding the services offered by ${company.name}, including pest control, landscaping, cleaning, window cleaning, screen cleaning, Christmas lights, pressure wash, soft wash and solar panel cleaning for residential and commercial properties in Puerto Rico. The site may also present services in development or coming soon, such as plumbing, electrical, water damage mitigation, handyman repairs, roof sealing and lead and asbestos mitigation. Information published on the site is general in nature and may be updated, corrected, or modified without prior notice.`}
                </p>
              </div>
